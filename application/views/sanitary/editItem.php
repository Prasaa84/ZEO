...
<div class="content-wrapper">
 	<div class="container-fluid">
    	...
    	<ol class="breadcrumb">
        	...
        	<li class="breadcrumb-item active">Library Resource Update</li>
      	</ol>
	        <?php
 			...
 			<?php 	foreach($item_result as $item){  
			 			$item_id = $item->san_item_id;
			 			$name = $item->san_item_name;
		            ...
		            <div class="col-lg-12 col-sm-12">
		              <div class="card mb-3">
		                <div class="card-header">
	                      ...
	                      <?php $attributes = array("class" => "form-horizontal", "id" => "update_san_info_form", "name" => "update-sanitary");
	                        	echo form_open("Sanitary/updateItem", $attributes);	?>
			                    		<fieldset>
			                    			...
			                    			<div class="form-group">
			                    				<div class="row">
			                    					...
			                    					<div class="col-lg-9 col-sm-9 ">
			                    						<input id="btn_edit_san_item" name="btn_edit_san_item" type="submit" class="btn btn-primary mr-2 mt-2" value="Update" />
			                    						<span name="is_deleted" value="<?php echo $is_deleted; ?>"></span>
			                    						<a href="<?php echo base_url(); ?>Sanitary/viewDetails" id="btn_cancel" name="btn_cancel" type="reset" class="btn btn-success mt-2" value="Cancel" style="margin-top: 10px;" >Cancel</a>
			                    					</div>
			                    				</div>
			                    			</div> <!-- /form group -->
			                    		</fieldset>
