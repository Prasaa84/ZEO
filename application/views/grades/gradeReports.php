    ...
    <div class="container-fluid">
      ...
      <div class="row" id="search-bar-row">    
        <div class="col-lg-12 col-sm-12">
          <form class="form-inline mb-1" id="srch_grades_by_school" name="srch_grades_by_school" action="<?php echo base_url(); ?>SchoolGrades/gradeReports" method="POST">
      ...
      <?php } ?>
            <button type="submit" class="btn btn-info mb-2 mr-sm-2 btn-sm" name="btn_view_grades_by_school" value="View" id="btn_view_grades_by_school"><i class="fa fa-search"></i> View </button>
          </form> <!-- /form -->
          ...
          <?php if(!empty($schoolGrades)) {  ?>   
                    ...
                    <table id="dataTable1" class="table table-striped table-hover" cellspacing="0">
                      <thead>
                        <tr>
                          ...
                          <th> ඇතුලත් කල සංඛ්‍යාව</th>
                          <th> ඇතුලත් කල ළමුන්ගේ ප්‍රතිශතය</th>
                    ...
                    <?php
                      ...
                      echo form_open("SchoolClasses/updateSchoolClass", $attributes); ?>                         
                        <tr>
                          ...
                          <td style="vertical-align:middle" align="center"><?php echo $student_count; ?></td>
                          ...
                          <td style="vertical-align:middle" ><?php echo $grade_head; ?> </td>
                ...
                ?>
                    ...
                    <div class="col ml-1 mb-1">
                      <a href="<?php echo base_url(); ?>ExcelExport/printSchoolGrades/<?php echo $census_id; ?>/<?php echo $year; ?>" type="button" class="btn btn-success mt-2 btn-sm" name="btn_print" id="btn_print" ><i class="fa fa-fw fa-file-excel-o"> </i> Export</a>
                    </div>
