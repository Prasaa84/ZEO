...
<div class="content-wrapper">
 	<div class="container-fluid">
    	...
    	<ol class="breadcrumb">
        	...
        	<li class="breadcrumb-item active">Physical Resource Update</a></li>
      	</ol>
	        <?php
		            ...
		            <div class="col-lg-12 col-sm-12">
		              <div class="card mb-3">
		                <div class="card-header">
	                      ...
	                      <?php $attributes = array("class" => "form-horizontal", "id" => "update-physical-resource", "name" => "update-physical-resource");
	                        	echo form_open("PhysicalResource/updateItem", $attributes);	?>
			                    		<fieldset>
			                    			...
			                    			<div class="form-group">
			                    				<div class="row">
			                    					<div class="col-lg-3 col-sm-3">
			                    						<label for="is deleted">ඉවත් කළ යුතුද?</label>
			                    					</div>
			                    					<div class="col-lg-9 col-sm-9">
				                    					<select class="form-control" id="item_delete_select" name="item_delete_select">
				                    						<option value="0" selected>නැත</option>
			                    			...
			                    			<div class="form-group">
			                    				<div class="row">
			                    					...
			                    					<div class="col-lg-9 col-sm-9 ">
			                    						<input id="btn_edit_phy_res_item" name="btn_edit_phy_res_item" type="submit" class="btn btn-primary mr-2 mt-2" value="Update" />
			                    						<a href="<?php echo base_url(); ?>PhysicalResource/viewAddPhysicalResourcePage" id="btn_cancel" name="btn_cancel" type="reset" class="btn btn-success mt-2" value="Cancel" style="margin-top: 10px;" >Cansel</a>
			                    					</div>
			                    				</div>
			                    			</div> <!-- /form group -->
			                    		</fieldset>
