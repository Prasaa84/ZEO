    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-lg-8">
          ...
          <div class="card mb-3">
            <div class="card-header">
              <i class="fa fa-building"></i> පුස්ථකාල තොරතුරු ඇතුළත් කිරීම
            </div>
            <div class="card-body">
              <div class="row">
                <div class="col-sm-12 my-auto">
                  <?php
                    $attributes = array("class" => "form-horizontal", "id" => "insert-librery-item-qty", "name" => "insert-librery-item-qty");
                    echo form_open("Library/addLibraryResourceQty", $attributes);?>
                  <fieldset>
                    ...
                    <div class="form-group">
                      <div class="row">
                        <div class="col-lg-3 col-sm-3">
                          <label for="quantity" class="control-label">තිබෙන මුළු ප්‍රමාණය</label>
                        </div>
                        <div class="col-lg-9 col-sm-9">
        ...
        <div class="col-lg-4">
          <div class="card mb-3">
            <div class="card-header">
              <i class="fa fa-building"></i> පුස්තකාල සම්පත් ඇතුළත් කිරීම
            </div>
            <div class="card-body">
              <div class="row">
                <div class="col-sm-12 my-auto">
                  <?php
                    $attributes = array("class" => "form-horizontal", "id" => "insert-librery-item", "name" => "insert-librery-item");
                    echo form_open("Furniture/addLibraryResource", $attributes);?>
                  <fieldset>
                    <div class="form-group">
                      <div class="row">
                        <div class="col-lg-3 col-sm-3">
