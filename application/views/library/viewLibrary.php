        ...
        <div class="col-lg-12 col-sm-12">
          <div class="row">
            <div class="col-lg-5 col-sm-5">
              <form class="navbar-form" role="search" id="srch_lib_item_info_by_censusid" name="srch_lib_item_info_by_censusid" action="<?php echo base_url(); ?>Library/viewItemStatusByCensusId" method="POST">
                    ...
                    <table id="dataTable" class="table table-striped table-hover" cellspacing="0">
                      <thead>
                        <tr>
                          ...
                          <th class="col-sm-3">තිබෙන සංඛ්‍යාව</th>
