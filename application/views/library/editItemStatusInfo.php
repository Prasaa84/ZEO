...
<div class="content-wrapper">
 	<div class="container-fluid">
    	...
    	<ol class="breadcrumb">
        	...
        	<li class="breadcrumb-item active">Library Resource Item Status Update</a></li>
      	</ol>
	        <?php
 			...
 			<?php 	foreach($item_status_details_result as $item){  
			 			$lib_res_detail_id = $item->lib_res_details_id;
			 			$census_id = $item->census_id;
			 			$item_id = $item->lib_res_id;
			 			$item_name = $item->lib_res_type;
			 			$qty = $item->quantity;
		            ...
		            <div class="col-lg-12 col-sm-12">
		              <div class="card mb-3">
		                <div class="card-header">
		                  <i class="fa fa-building"></i> පුස්තකාල සම්පත් වල ප්‍රමාණයන් යාවත්කාලීන කිරීම
		                </div>
		                	<div class="card-body">
		                  		<div class="row">
		                    		<div class="col-sm-12 my-auto">
	                      <?php $attributes = array("class" => "form-horizontal", "id" => "update-library-resource-status-details", "name" => "update-library-resource-status-details");
	                        	echo form_open("Library/updateItemStatusDetails", $attributes);	?>
			                    		<fieldset>
			                    			<div class="form-group">
			                    				<div class="row">
			                    					...
			                    					<div class="col-lg-9 col-sm-9">
			                    						...
			                    						<input type="hidden" name="lib_res_detail_id" value="<?php echo $lib_res_detail_id ; ?>" />
			                    					</div>
			                    				</div> <!-- /row -->
			                    			</div> <!-- /form group -->
											<div class="form-group">
			                    			...
			                    			<div class="form-group">
			                    				<div class="row">
			                    					...
			                    					<div class="col-lg-9 col-sm-9 ">
			                    						<input id="btn_edit_lib_res_item_status_details" name="btn_edit_lib_res_item_status_details" type="submit" class="btn btn-primary mr-2 mt-2" value="Update" />
			                    						<a href="<?php echo base_url(); ?>Library/goBackFromUpdate/<?php echo $census_id; ?>" id="btn_back" name="btn_back" type="button" class="btn btn-success mt-2" value="Back" style="margin-top: 10px;" >Back</a>
			                    					</div>
			                    				</div>
			                    			</div> <!-- /form group -->
			                    		</fieldset>
