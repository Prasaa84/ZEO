              ...
              <form class="navbar-form form-inline" role="search" id="srch_user_log" name="srch_user_log" action="<?php echo base_url(); ?>User/viewUserLog" method="POST">
                <div class="form-group col-lg-2 col-sm-2">
                  <div class="input-group addon">
                    <input class="form-control" placeholder="User ID..." name="userid_txt" id="userid_txt" type="text" value="<?php echo set_value('userid_txt'); ?>" data-toggle="tooltip" title="User ID">
                  </div> <!-- /input-group -->
                </div>
                <div class="form-group col-lg-2 col-sm-2">
                  <div class="input-group addon">
                    <input class="form-control" placeholder="Census ID..." name="censusid_txt" id="censusid_txt" type="text" value="<?php echo set_value('censusid_txt'); ?>" data-toggle="tooltip" title="Census ID">
                  </div> <!-- /input-group -->
                </div>
                <div class="form-group col-lg-2 col-sm-2">
                  <div class="input-group addon">
                    <input class="form-control datepicker" name="frmdate_txt" id="frmdate_txt" type="date" data-toggle="tooltip" title="From Date">
                  </div> <!-- /input-group -->
                </div>
                <div class="form-group col-lg-2 col-sm-2">
                  <div class="input-group addon">
                    <input class="form-control datepicker" name="todate_txt" id="todate_txt" type="date" data-toggle="tooltip" title="To Date">
                  </div> <!-- /input-group -->
                </div>
                <div class="form-group col-lg-2 col-sm-2">
                  <div class="input-group addon">
                    <select class="form-control" id="select_user_act" name="select_user_act" data-toggle="tooltip" title="User Action">
                ...
                <div class="form-group col-lg-2 col-sm-2">
                  <input id="btn_view_userlog" name="btn_view_userlog" type="submit" class="btn btn-primary" value="Submit" />
                </div> <!-- /.form-group -->
              </form> <!-- /form -->
              </div>
                    ...
                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                      ...
                      <?php 
                        ...
                        foreach ($user_log_details as $row){  
                          ...
                          $added_date = date("Y-m-d",strtotime($userlog_added_dt));
                      ?>
                        <tr>
                          ...
                          <td style="vertical-align:middle"><?php echo $added_date; ?></td>
                        </tr>
                      <?php } ?>
                      </tbody>
                    </table>
