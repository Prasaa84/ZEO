            ...
            <div class="row">
                <div class="features">
                	‍<div class="row">
                        ...
                        <div class="col-md-4 col-sm-6 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
                            <div class="feature-wrap">
                                ...
                                <h2>සේවක ස්ථාන මාරුවීම්</h2>
                                <h3>අන්තර් කලාප හා අන්තර් ප‍ලාත් ස්‍ථාන මාරු</h3>
                            </div>
                        </div><!--/.col-md-4-->
                        <div class="col-md-4 col-sm-6 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
                            <div class="feature-wrap">
                                <a href="<?php echo base_url(); ?>TeacherInstitution/personalFile"><i class="fa fa-home"></i></a>
                	...
                	‍<div class="row">
                        ...
                        <div class="col-md-4 col-sm-6 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
                            <div class="feature-wrap">
                                <a href="<?php echo base_url(); ?>TeacherInstitution/serviceRelated"><i class="fa fa-home"></i></a>
                                <h2>සේවය පිළිබඳ...</h2>
                        ...
                        <div class="col-md-4 col-sm-6 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
                            <div class="feature-wrap">
                                ...
                                <h2>අන්තර්ග්‍රහ‍ණය</h2>
                                <h3>දකු‍ණු පලාත් රාජ‍්‍ය සේවයට අන්තර්ග්‍රහ‍ණය කිරීම</h3>
                            </div>
                        </div><!--/.col-md-4-->
                        <div class="col-md-2 col-sm-6 ">
                    	</div>
