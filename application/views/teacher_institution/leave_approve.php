                	...
                	‍<div class="row">
                        <div class="col-md-4 col-sm-4 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
                            <div class="feature-wrap">
                                <a href="<?php echo base_url(); ?>TeacherInstitution/maternityLeavesWithFullPay"><i class="fa fa-home"></i></a>
                        ...
                        <div class="col-md-4 col-sm-4 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
                            <div class="feature-wrap">
                                <a href="<?php echo base_url(); ?>TeacherInstitution/maternityLeavesWithHalfPay"><i class="fa fa-home"></i></a>
                        ...
                        <div class="col-md-4 col-sm-4 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
                            <div class="feature-wrap">
                                <a href="<?php echo base_url(); ?>TeacherInstitution/maternityLeavesWithNoPay">
                	...
                	‍<div class="row">
                        <div class="col-md-4 col-sm-4 wow fadeInDown right" data-wow-duration="1000ms" data-wow-delay="600ms">
                            <div class="feature-wrap right">
                                <a href="<?php echo base_url(); ?>TeacherInstitution/paternalLeave">
                                <i class="fa fa-home"></i></a>
                        ...
                        <div class="col-md-4 col-sm-4 wow fadeInDown left" data-wow-duration="1000ms" data-wow-delay="600ms">
                            <div class="feature-wrap">
                                <a href="<?php echo base_url(); ?>TeacherInstitution/accidentLeave">
                        ...
                        <div class="col-md-4 col-sm-4 wow fadeInDown right" data-wow-duration="1000ms" data-wow-delay="600ms"">
                            <div class="feature-wrap">
                                <a href="<?php echo base_url(); ?>TeacherInstitution/abroadLeave">
