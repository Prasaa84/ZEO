...
<div class="content-wrapper">
 	<div class="container-fluid">
    	...
    	<ol class="breadcrumb">
        	...
        	<li class="breadcrumb-item active">Computer Resources Update</a></li>
      	</ol>
	        <?php
		            ...
		            <div class="col-lg-12 col-sm-12">
		              <div class="card mb-3">
		                <div class="card-header">
	                      ...
	                      <?php $attributes = array("class" => "form-horizontal", "id" => "update_com_lab_res_info_form", "name" => "update-computer-resource");
	                        	echo form_open("ComputerLab/updateItem", $attributes);	?>
			                    		<fieldset>
			                    			...
			                    			<div class="form-group">
			                    				<div class="row">
			                    					...
			                    					<div class="col-lg-9 col-sm-9 ">
			                    						<input id="btn_edit_com_res_item" name="btn_edit_com_res_item" type="submit" class="btn btn-primary mr-2 mt-2" value="Update" />
			                    						<span name="is_deleted" value="<?php echo $is_deleted; ?>"></span>
			                    						<a href="<?php echo base_url(); ?>ComputerLab/viewDetails" id="btn_cancel" name="btn_cancel" type="reset" class="btn btn-success mt-2" value="Cancel" style="margin-top: 10px;" >Cancel</a>
			                    					</div>
			                    				</div>
			                    			</div> <!-- /form group -->
			                    		</fieldset>
