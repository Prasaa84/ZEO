...
<script type="text/javascript">
  $(document ).ready(function() {  
    ...
    var cData = JSON.parse(`<?php echo $this->student_count; ?>`);      
    var ctx = document.getElementById("barChartStudents");
      ...
      var cData = JSON.parse(`<?php echo $this->student_count_genderwise; ?>`);      
      // Pie Chart Example
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <!-- Icon Cards-->
      <div class="row">
        <?php if($this->session->userdata['userrole'] != 'Divisional User'){ ?>
        <div class="col-xl-3 col-sm-6 mb-3">
          <div class="card text-white bg-warning o-hidden h-100">
            <div class="card-body">
              ...
              <div class="mr-5">Add Students</div>
            </div>
            <a class="card-footer text-white clearfix small z-1" href="<?php echo base_url(); ?>student/viewStudent">
        ...
        <div class="col-xl-3 col-sm-6 mb-3">
          <div class="card text-white bg-info o-hidden h-100">
            <div class="card-body">
              ...
              <div class="mr-5">Student Reports</div>
            </div>
            <a class="card-footer text-white clearfix small z-1" href="<?php echo base_url(); ?>student/studentReportsPage">
        ...
        <div class="col-xl-3 col-sm-6 mb-3">
          <div class="card text-white bg-success o-hidden h-100">
            <div class="card-body">
              ...
              <div class="mr-5">Find Parents</div>
            </div>
            <a class="card-footer text-white clearfix small z-1" href="<?php echo base_url(); ?>student/findParentPage">
        ...
        <div class="col-lg-8">
          <div class="card mb-3">
            ...
            <div class="card-footer small text-muted">
              <?Php 
                $stdata = json_decode($this->student_count,true);
