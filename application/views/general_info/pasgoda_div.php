		...
		<div id="carousel-slider" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner">
			   <div class="item active">
				<img src="<?php echo base_url(); ?>assets/images/divisions/pasgoda_division_slider.png" class="img-responsive" alt="">
			   </div>
			   <div class="item">
				<img src="<?php echo base_url(); ?>assets/images/divisions/pasgoda_division_slider.png" class="img-responsive" alt="">
			   </div>
    ...
    <section id="schools_div">
        <div class="container">
            <div class="wow fadeInDown" style="">
                <h2 class="h2 center">Schools in Pasgoda division </h2><br>
