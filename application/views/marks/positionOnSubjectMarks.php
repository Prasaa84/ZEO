...
?>
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Student Position on Subject Marks</li>
      </ol>
      <?php
                  ...
                  <?php $attributes = array("class" => "form-inline", "id" => "import_marks_form", "name" => "import_marks_form", "role" => "search", "enctype" => "multipart/form-data");
                    ...
                    <?php } ?>
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-1 col-sm-1">
                              <select class="form-control form-control-sm mb-1" id="subject_select" name="subject_select" data-toggle="tooltip" title="Select a Class">
                                <option value="" selected>------</option>
                              </select>
  ...
  <?php } ?> 
        ...
        if( census_id=='' || year=='' || term=='' || grade_id=='' || subject_id=='' ){
          swal('Year, Term, Grade and Subject are required!!!');
        }else{
          $.ajax({
            url:"<?php echo base_url(); ?>Marks/positionOnSubjectMarks",
            dataSrc: "Data",
            method:"POST",
            data:{census_id:census_id,year:year,term:term,grade_id:grade_id,class_id:class_id,subject_id:subject_id}, 
